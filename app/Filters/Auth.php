        ...
        try {
            ...
            if(isset($arguments) && $arguments[0] == 'mustNotBeLoggedIn'){
                ...
                if(!$isValidHardwareID){
                    return throwResponseUnauthorized('[E-AUTH-001.1.2] Hardware ID Anda telah berubah, silakan masuk kembali untuk melanjutkan', ['idUserAdmin' => $idUserAdmin, 'hardwareID' => $hardwareID]);
                }
