<div id="containerMenuDaftarHarga" class="pos">
    <h1 class="page-header">Daftar Harga <small>Daftar harga produk per kelompok harga</small></h1>
    <hr class="mb-4">
    <div class="card">
                    ...
                    <tr>
                        <td>
                            <div class="d-flex align-items-center">
                                ...
                                <div class="ms-3">
                                    <a href="page_product_details.html">Eco-friendly fashion, organic cotton, slow fashion polo shirts</a>
                                </div>
                            </div>
                        </td>
                    ...
                    <tr>
                        <td>
                            <div class="d-flex align-items-center">
                                ...
                                <div class="ms-3">
                                    <a href="page_product_details.html">Nike Shoes (Red Color)</a>
                                </div>
                            </div>
                        </td>
                    ...
                    <tr>
                        <td>
                            <div class="d-flex align-items-center">
                                ...
                                <div class="ms-3">
                                    <a href="page_product_details.html">Nike Air Max (Blue Color)</a>
                                </div>
                            </div>
                        </td>
                        <td class="align-middle">19 in stock for 1 variants</td>
                    ...
                    <tr>
                        <td>
                            <div class="d-flex align-items-center">
                                ...
                                <div class="ms-3">
                                    <a href="page_product_details.html">Skate Sneaker (Orange Color)</a>
                                </div>
                            </div>
                        </td>
                        <td class="align-middle">19 in stock for 1 variants</td>
                    ...
                    <tr>
                        <td>
                            <div class="d-flex align-items-center">
                                ...
                                <div class="ms-3">
                                    <a href="page_product_details.html">Teen Fashion T-shirt (Black)</a>
                                </div>
                            </div>
                        </td>
                    ...
                    <tr>
                        <td>
                            <div class="d-flex align-items-center">
                                ...
                                <div class="ms-3">
                                    <a href="page_product_details.html">Levis Blue Jeans</a>
                                </div>
                            </div>
                        </td>
                    ...
                    <tr>
                        <td>
                            <div class="d-flex align-items-center">
                                ...
                                <div class="ms-3">
                                    <a href="page_product_details.html">Boots (White Color)</a>
                                </div>
                            </div>
                        </td>
                        <td class="align-middle">19 in stock for 1 variants</td>
                    ...
                    <tr>
                        <td>
                            <div class="d-flex align-items-center">
                                ...
                                <div class="ms-3">
                                    <a href="page_product_details.html">Hiking Boots</a>
                                </div>
                            </div>
                        </td>
                    ...
                    <tr>
                        <td>
                            <div class="d-flex align-items-center">
                                ...
                                <div class="ms-3">
                                    <a href="page_product_details.html">Dress (Pink)</a>
                                </div>
                            </div>
                        </td>
        ...
        <div class="d-md-flex align-items-center p-4">
            <div class="me-md-auto text-md-left text-center mb-2 mb-md-0">
                Menampilkan data ke-1 sampai 10 dari 57 data
            </div>
...
<script>
	var jsFileUrl   =   "<?=BASE_URL_ASSETS_JS?>menu/daftarHarga.js?<?=date("YmdHis")?>";
	$.getScript(jsFileUrl);
</script>