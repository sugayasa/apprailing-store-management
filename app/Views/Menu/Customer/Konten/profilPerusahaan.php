                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="text-center mb-3">
                            <img class="mb-2 rounded" src="<?=$defaultImage ?? 'defaultThumbnail.jpg'?>" id="imgThumbnailVideo" style="max-width: 500px; max-height: 209px;"/><br/>
...
<script>
	var baseURLImage=   "<?=BASE_URL_ASSETS_VIDEO_COMPANY_PROFILE?>",
        defaultImage=   "<?=$defaultImage ?? 'defaultThumbnail.jpg'?>",
