...
class Assets extends ResourceController
{
    ...
    public function imageMarketing($namaFile)
    {
        $fullFilePath   =   PATH_STORAGE_IMAGE_MARKETING.$namaFile;
        $isDefault      =   strpos($namaFile, 'default') !== false;
    ...
    {
        $fullFilePath   =   PATH_STORAGE_CUSTOMER_SOSMED_MARKETPLACE.$namaFile;
        $isDefault      =   strpos($namaFile, 'default') !== false;
    ...
    public function customerProduk($namaFile)
    {
        ...
        $isDefault      =   strpos($namaFile, 'noimage') !== false;
        $defaultFilePath=   PATH_STORAGE_CUSTOMER_PRODUK  .'noimage.jpg';
