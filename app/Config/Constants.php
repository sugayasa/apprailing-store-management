...
defined('APP_COMPANY_NAME')                             || define('APP_COMPANY_NAME', $_ENV['APP_COMPANY_NAME'] ?: 'Store Management');
defined('APP_NAME')                                     || define('APP_NAME', $_ENV['APP_NAME'] ?: 'Store Management');
defined('APP_NAME_FORMAL')                              || define('APP_NAME_FORMAL', $_ENV['APP_NAME_FORMAL'] ?: 'Store Management');
...
defined('BASE_URL_ASSETS_SLIDE_ONBOARDING')             || define('BASE_URL_ASSETS_SLIDE_ONBOARDING', BASE_URL_ASSETS_CUSTOM.$_ENV['BASE_URL_ASSETS_SLIDE_ONBOARDING'] ?: 'imageSlideOnboarding/');
defined('BASE_URL_ASSETS_SLIDE_BANNER')                 || define('BASE_URL_ASSETS_SLIDE_BANNER', BASE_URL_ASSETS_CUSTOM.$_ENV['BASE_URL_ASSETS_SLIDE_BANNER'] ?: 'imageSlideBanner/');
defined('BASE_URL_ASSETS_SLIDE_KOLABORASI_PRODUK')      || define('BASE_URL_ASSETS_SLIDE_KOLABORASI_PRODUK', BASE_URL_ASSETS_CUSTOM.$_ENV['BASE_URL_ASSETS_SLIDE_KOLABORASI_PRODUK'] ?: 'imageSlideKolaborasi/produk/');
defined('BASE_URL_ASSETS_SLIDE_KOLABORASI_THUMBNAIL')   || define('BASE_URL_ASSETS_SLIDE_KOLABORASI_THUMBNAIL', BASE_URL_ASSETS_CUSTOM.$_ENV['BASE_URL_ASSETS_SLIDE_KOLABORASI_THUMBNAIL'] ?: 'imageSlideKolaborasi/thumbnail/');
defined('BASE_URL_ASSETS_VIDEO_COMPANY_PROFILE')        || define('BASE_URL_ASSETS_VIDEO_COMPANY_PROFILE', BASE_URL_ASSETS_CUSTOM.$_ENV['BASE_URL_ASSETS_VIDEO_COMPANY_PROFILE'] ?: 'videoCompanyProfile/');
defined('BASE_URL_ASSETS_VIDEO_CARA_PASANG')            || define('BASE_URL_ASSETS_VIDEO_CARA_PASANG', BASE_URL_ASSETS_CUSTOM.$_ENV['BASE_URL_ASSETS_VIDEO_CARA_PASANG'] ?: 'videoCaraPasang/');
...
defined('BASE_URL_ASSETS_GALERI_PROYEK')                || define('BASE_URL_ASSETS_GALERI_PROYEK', BASE_URL_ASSETS_CUSTOM.$_ENV['BASE_URL_ASSETS_GALERI_PROYEK'] ?: 'imageGaleriProyek/');
...
defined('PATH_STORAGE_IMAGE_MARKETING')                 || define('PATH_STORAGE_IMAGE_MARKETING', PATH_STORAGE_PHOTO.$_ENV['PATH_STORAGE_IMAGE_MARKETING'] ?: PATH_STORAGE_PHOTO.'customer_marketing/');
defined('PATH_STORAGE_PHOTO_SLIDE_ONBOARDING')          || define('PATH_STORAGE_PHOTO_SLIDE_ONBOARDING', PATH_STORAGE_PHOTO.$_ENV['PATH_STORAGE_PHOTO_SLIDE_ONBOARDING'] ?: PATH_STORAGE_FILE.'customer_slide_boarding/');
defined('PATH_STORAGE_PHOTO_SLIDE_BANNER')              || define('PATH_STORAGE_PHOTO_SLIDE_BANNER', PATH_STORAGE_PHOTO.$_ENV['PATH_STORAGE_PHOTO_SLIDE_BANNER'] ?: PATH_STORAGE_FILE.'customer_slide_banner/');
defined('PATH_STORAGE_PHOTO_SLIDE_KOLABORASI_PRODUK')   || define('PATH_STORAGE_PHOTO_SLIDE_KOLABORASI_PRODUK', PATH_STORAGE_PHOTO.$_ENV['PATH_STORAGE_PHOTO_SLIDE_KOLABORASI_PRODUK'] ?: PATH_STORAGE_FILE.'customer_slide_kolaborasi/produk/');
defined('PATH_STORAGE_PHOTO_SLIDE_KOLABORASI_THUMBNAIL')|| define('PATH_STORAGE_PHOTO_SLIDE_KOLABORASI_THUMBNAIL', PATH_STORAGE_PHOTO.$_ENV['PATH_STORAGE_PHOTO_SLIDE_KOLABORASI_THUMBNAIL'] ?: PATH_STORAGE_FILE.'customer_slide_kolaborasi/thumbnail/');
defined('PATH_STORAGE_VIDEO_COMPANY_PROFILE')           || define('PATH_STORAGE_VIDEO_COMPANY_PROFILE', PATH_STORAGE_PHOTO.$_ENV['PATH_STORAGE_VIDEO_COMPANY_PROFILE'] ?: PATH_STORAGE_FILE.'customer_video_company_profile/');
defined('PATH_STORAGE_VIDEO_CARA_PASANG')               || define('PATH_STORAGE_VIDEO_CARA_PASANG', PATH_STORAGE_PHOTO.$_ENV['PATH_STORAGE_VIDEO_CARA_PASANG'] ?: PATH_STORAGE_FILE.'customer_video_cara_pasang/');
...
defined('PATH_STORAGE_PHOTO_GALERI_PROYEK')             || define('PATH_STORAGE_PHOTO_GALERI_PROYEK', PATH_STORAGE_PHOTO.$_ENV['PATH_STORAGE_PHOTO_GALERI_PROYEK'] ?: PATH_STORAGE_FILE.'customer_galeri_proyek/');
